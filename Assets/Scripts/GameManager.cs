...
{   
    ...
    private void OnClickStartButton()
    {
        ...
        GameObject resGO = Resources.Load<GameObject>("Prefab/ModeUI"); //UI매니저에 존재함
    ...
    private IEnumerator LoadSceneAsync(string sceneName) //SceneManager에 옮김
    {
        ...
        // 게임 UI 로드하는 부분 
        GameObject scoreUIRes = Resources.Load<GameObject>("Prefab/ScoreUI"); //UIManager에 옮김
